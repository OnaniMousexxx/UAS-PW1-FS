...
function showModal(title, price, description, imageSrc) {
  ...
  modalContent.innerHTML = `
    <div class="text-center">
      ...
      <a href="https://api.whatsapp.com/send?phone=6287761974119&text=Saya ingin membeli produk ini: ${encodeURIComponent(title)}" target="_blank" class="btn btn-warning">Beli Produk Ini</a>
    </div>
  `;
